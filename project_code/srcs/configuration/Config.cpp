...
/*   Updated: 2023/06/27 01:54:08 by ahsalem          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	error_page 404 test/www/error404.html;
    ...
    servers.push_back(std::map<std::string, std::string>());
    servers[0]["server_name"] = "localhost";
    servers[0]["server_name"] = "default_server";
    servers[0]["Port"] = "8080";
    servers[0]["root"] = pwd + "test/www";

    servers[0]["index"] = "index.html";
    servers[0]["/"] = servers[0]["root"] + "/" + servers[0] ["index"];
    servers[0]["/2"] = servers[0]["root"] + "test/www";
    servers[0]["/2 index"] = servers[0]["/2"] + "/" + "second.html";
    servers[0]["/virtual"] = servers[0]["root"] + "test/www";
    servers[0]["/post"] = servers[0]["root"] + "test/www";
    servers[0]["/put"] = servers[0]["root"] + "test/www";
    servers[0]["/index"] = servers[0]["root"] + "test/www";
    servers[0]["/protected"] = servers[0]["root"] + "test/www/protected";
    ...
    servers.push_back(std::map<std::string, std::string>());
    servers[1]["server_name 0"] = "localhost";
    servers[1]["server_name 1"] = "default_server";
    servers[1]["Port"] = "8081";
    servers[1]["root"] = pwd + "test/www";
    ...
    servers.push_back(std::map<std::string, std::string>());
    servers[2]["server_name 0"] = "google.com";
    servers[2]["Port"] = "8080";
    servers[2]["root"] = pwd +  "test/www";
    servers[2]["index"] = "google.html";
    servers[2]["/"] = servers[2]["root"] + "/" + servers[2] ["index"];
    servers[2]["/auto "] = pwd+ "test/www/auto";
    servers[1]["DELETE path"] = "POST";
